...
class EpicTest {
    ...
    public void shouldWhenAddTaskWithUsedIdTaskIsRecord() {
        ...
        Epic epic = new Epic("Epic1", "DesctiptionEpic1", TaskState.NEW, includeSubtaskList1);
        Epic savedEpic = new Epic("Epic1.1", "DesctiptionEpic1.1", TaskState.DONE, includeSubtaskList2);
